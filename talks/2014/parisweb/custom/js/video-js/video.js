...
(function () {
    ...
    u.j = function (a, c) {
        ...
        c = u.ic(c);
        d.U && d.U.call(a, c);
        if (e && !c.Bb() && c.bubbles !== l)u.j(e, c); else if (!e && !c.zb() && (d = u.getData(c.target), c.target[c.type])) {
            d.disabled = f;
    ...
    var ba = u, y;
    var z = u.I.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i), A, B;
    ...
    u.b = u.ka.extend({h: function (a, c, d) {
        this.c = a;
    ...
    t.removeChild = function (a) {
        ...
        if (a && this.J) {
            for (var c = l, d = this.J.length - 1; 0 <= d; d--)if (this.J[d] === a) {
                c = f;
                this.J.splice(d, 1);
                break
            }
    ...
    t.La = function () {
        ...
        this.options().title && a.u().appendChild(u.e("li", {className: "vjs-menu-title", innerHTML: u.Z(this.A), Bd: -1}));
    ...
    t.e = function () {
        var a = this.a = u.b.prototype.e.call(this, "div"), c = this.L;
    ...
    t.cancelFullScreen = function () {
        var a = u.Ob.requestFullScreen;
        this.isFullScreen(l);
        if (a)document[a.ob](); else this.i.Va() ? L(this, "exitFullScreen") : (M(this), this.j("fullscreenchange"));
        return this
    };
    t.jc = function (a) {
    ...
    u.Ca = u.b.extend();
    u.Ca.prototype.g = {Pd: "play", children: {playToggle: {}, currentTimeDisplay: {}, timeDivider: {}, durationDisplay: {}, remainingTimeDisplay: {}, progressControl: {}, fullscreenToggle: {}, volumeControl: {}, muteToggle: {}}};
    u.Ca.prototype.e = function () {
        return u.e("div", {className: "vjs-control-bar"})
    };
    u.Xb = u.q.extend({h: function (a, c) {
        u.q.call(this, a, c);
    ...
    u.ab = u.b.extend({h: function (a, c) {
        u.b.call(this, a, c);
        a.d("timeupdate", u.bind(this, this.da))
    }});
    ...
    u.Da = u.q.extend({h: function (a, c) {
        u.q.call(this, a, c)
    }});
    ...
    u.fb = u.b.extend({h: function (a, c) {
        u.b.call(this, a, c)
    }});
    ...
    u.Yb = u.N.extend({h: function (a, c) {
        u.N.call(this, a, c);
    ...
    u.cb = u.b.extend({h: function (a, c) {
        u.b.call(this, a, c);
    ...
    u.Wb = u.b.extend({h: function (a, c) {
        u.b.call(this, a, c)
    }});
    ...
    u.Fa = u.V.extend({h: function (a, c) {
        u.V.call(this, a, c);
        a.d("timeupdate", u.bind(this, this.da))
    }});
    ...
    u.ib = u.b.extend({h: function (a, c) {
        u.b.call(this, a, c);
    ...
    u.hb = u.N.extend({h: function (a, c) {
        u.N.call(this, a, c);
    ...
    u.cc = u.b.extend({h: function (a, c) {
        u.b.call(this, a, c)
    }});
    ...
    u.ea = u.q.extend({h: function (a, c) {
        u.q.call(this, a, c);
    ...
    u.ma = u.R.extend({h: function (a, c) {
        u.R.call(this, a, c);
        a.d("volumechange", u.bind(this, this.update));
    ...
    u.ma.prototype.La = function () {
        var a = new u.la(this.c, {Uc: "div"}), c = new u.hb(this.c, u.k.B({Ed: f}, this.g.Yd));
        a.Y(c);
        return a
    };
    ...
    u.Vb = u.b.extend({h: function (a, c) {
        u.b.call(this, a, c);
    ...
    t.e = function () {
        ...
        if (!c || this.m.movingMediaElementInDOM === l)c ? (d = c.cloneNode(l), u.l.gc(c), c = d, a.L = h) : c = u.e("video", {id: a.id() + "_html5_api", className: "vjs-tech"}), c.player = a, u.yb(c, a.u());
    ...
    u.f = u.r.extend({h: function (a, c, d) {
        ...
        a = a.g;
        var k = u.k.B({readyFunction: "videojs.Flash.onReady", eventProxyFunction: "videojs.Flash.onEvent", errorEventProxyFunction: "videojs.Flash.onError", autoplay: a.autoplay, preload: a.Ra, loop: a.loop, muted: a.muted}, c.flashVars), q = u.k.B({wmode: "opaque", bgcolor: "#000000"}, c.params), n = u.k.B({id: j, name: j, "class": "vjs-tech"}, c.attributes), s;
    ...
    function fa() {
        var a = S[U], c = a.charAt(0).toUpperCase() + a.slice(1);
        R["set" + c] = function (c) {
    ...
    u.f.Ac = {"rtmp/mp4": "MP4", "rtmp/flv": "FLV"};
    ...
    t.update = function () {
        if (0 < this.$.length) {
            ...
            if (this.Lb === b || a < this.Lb || this.Na <= a) {
                var c = this.$, d = this.c.duration(), e = 0, g = l, j = [], k, q, n, s;
                a >= this.Na || this.Na === b ? s = this.vb !== b ? this.vb : 0 : (g = f, s = this.Cb !== b ? this.Cb : c.length - 1);
                for (; ;) {
                    n = c[s];
                    if (n.sa <= a)e = Math.max(e, n.sa), n.Ha && (n.Ha = l); else if (a < n.startTime) {
    ...
    u.eb = u.X.extend({h: function (a, c) {
        c.track = {G: function () {
            return c.kind
        }, C: a, label: function () {
            return c.kind + " off"
    ...
    u.S.prototype.qa = function () {
        ...
        for (var d = 0; d < this.c.textTracks().length; d++)c = this.c.textTracks()[d], c.G() === this.A && a.push(new u.X(this.c, {track: c}));
        return a
    };
    u.Aa = u.S.extend({h: function (a, c, d) {
        u.S.call(this, a, c, d);
    ...
    u.Ba = u.S.extend({h: function (a, c, d) {
        u.S.call(this, a, c, d);
    ...
    t.qa = function () {
        for (var a = [], c, d = 0; d < this.c.textTracks().length; d++)c = this.c.textTracks()[d], c.G() === this.A && a.push(new u.X(this.c, {track: c}));
        return a
    };
    t.La = function () {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, j = this.K = []; c < d; c++)if (e = a[c], e.G() == this.A && e.tb()) {
            if (2 > e.readyState()) {
                this.Ld = e;
        ...
        a.a.appendChild(u.e("li", {className: "vjs-menu-title", innerHTML: u.Z(this.A), Bd: -1}));
        if (g) {
            e = g.$;
    ...
    u.Za = u.M.extend({h: function (a, c) {

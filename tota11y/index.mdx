...
You should now see a button in your bookmark bar:
 ...
 ![Tota11y bookmark in bookmarks bar](/pages/blog/Tota11y/bookmarklet.png)
 ...
 ![Tota11y icon on bottom left of the current webpage](/pages/blog/Tota11y/totally-small.png)

 Clicking this icon will expand the menu:

![Tota11y full menu](/pages/blog/Tota11y/tota11y-expanded.png)
...
![Headings info panel showing an error](/pages/blog/Tota11y/headings-summary.png)
...
![Headings info panel showing an error](/pages/blog/Tota11y/headings-errors.png)
...
![the "sniper rifle sight thing that Jack Roles made" icon](/pages/blog/Tota11y/pinpoint.png)
...
![Areas of good contrast highligted](/pages/blog/Tota11y/good-contrast.png)
...
![Areas of inadequate contrast highligted](/pages/blog/Tota11y/bad-contrast.png)
...
![red overlay reading "Image is missing alt text"](/pages/blog/Tota11y/no-alt.png)
...
![amber-coloured overlay reading "This image is decorative"](/pages/blog/Tota11y/decorative.png)
...
![amber-coloured overlay showing bad alt text](/pages/blog/Tota11y/bad-alt.png)
...
![amber-coloured overlay showing multiple br elements](/pages/blog/Tota11y/empty-br.png)
...
![amber-coloured overlay showing an empty LI element](/pages/blog/Tota11y/empty-li.png)
...
![landmarks and roles outlined and exposed](/pages/blog/Tota11y/landmarks.png)
...
![an erroneously missing title, and a superfluous title](/pages/blog/Tota11y/title.png)
...
![info panel reveals that the form's label and associated information are associated programmatically to the input being hovered](/pages/blog/Tota11y/last.png)
